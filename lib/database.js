...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         *   - `.code` = {@link errors.queryResultErrorCode.multiRow queryResultErrorCode.multiRow}
         ...
         * @method Database#any
         * @description
         * Executes a query without any expectation for the data to be returned.
         *
         * @param {string|object} query
         * Query to be executed, which can any of the following types:
         * - A non-empty query string
         ...
         * @description
         * Executes a query that expects any number of rows, using mask `many`|`none`.
         * When no rows are returned, the result is replaced with an empty array.
         *
         * @param {string|object} query
         * Query to be executed, which can any of the following types:
         * - A non-empty query string
         ...
         * - When 1 or more rows are returned, it resolves with the array of rows.
         */
        obj.rows = function (query, values) {
            return obj.query.call(this, query, values, npm.result.many | npm.result.none)
                .then(a => a || []);
        };
        ...
        obj.multi = function (query, values) {
            return obj.query.call(this, query, values, npm.result.multi);
        };
        ...
        obj.map = function (query, values, cb, thisArg) {
            return obj.rows.call(this, query, values)
