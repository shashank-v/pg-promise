 ...
 * Supported errors:
 *
 * - `No return data was expected.`, for method {@link Database#none none}
 * - `No data returned from the query.`, for methods {@link Database#one one} and {@link Database#many many}
 * - `Multiple rows were not expected.`, for methods {@link Database#one one} and {@link Database#oneOrNone oneOrNone}
 * - `Multiple results were not expected.`, for all methods, except {@link Database#multi multi} and {@link Database#multiResult multiResult}
 *
 ...
 * The original $[Result] object that was received. In case of a multi-result, it is an array of $[Result] objects.
 *
 * @property {number} [received]
 * Total number of rows received (it is simply the value of `result.rows.length`).
 * The value is not set in case of a multi-result.
 *
